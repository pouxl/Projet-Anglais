 ...
 */
public class InteractionKaraokeTime implements  ActionListener, ItemListener{
		private FenetrePlaylistKaraoke  fenetrePlaylist;
		private GestionPlaylistKaraoke  gestionPlaylist;
		private JFileChooser chooser;
		private	ExampleFileFilter filter = new ExampleFileFilter( "kpl", "Karaoke Time Playlist");

		/** Constructeur de Karaoke Time
		 */
		public InteractionKaraokeTime () {
		...
		/** Methode main creant KaraokeTime
		 */
		public static void main (String argv[]) {
				new InteractionKaraokeTime ();
		}
